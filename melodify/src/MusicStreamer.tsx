...
import { Play, Pause, SkipBack, SkipForward, Volume2, Home, Search, Library, PlusCircle, Heart } from 'lucide-react'
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="flex-1 bg-black bg-opacity-20 p-8 overflow-y-auto rounded-tl-3xl shadow-inner backdrop-blur-md">
            <Routes>
              ...
              <Route path="/favorites" element={<FavoritesPage songs={allSongs} currentSong={currentSong} setCurrentSong={setCurrentSong} setIsPlaying={setIsPlaying} toggleFavorite={toggleFavorite} favorites={favorites} accentColor={currentSong.colors.accent} />}
              />
